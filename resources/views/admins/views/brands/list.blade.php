        ...
        <tbody>
            @if (!empty($brandList))
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{route('admin.brand.edit', ['id' => $item->brand_id])}}" class="btn btn-warning btn-sm">Edit</a>
                    </td>
                    <td>
                        <a onclick="return confirm('Are you sure you want to delete?')" href="{{route('admin.brand.delete', ['id' => $item->brand_id])}}" class="btn btn-danger btn-sm">Delete</a>
                    </td>
                </tr>
                @endforeach
            @else 
